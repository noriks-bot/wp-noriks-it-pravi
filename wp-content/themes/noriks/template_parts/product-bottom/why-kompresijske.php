...
<section class="why-section knc-demo">
  <div class="knc-demo-wrap">
    <h2 class="knc-demo-title">Come funziona nella pratica</h2>
...
<section class="why-section knc-compare-section">
  <div class="knc-compare-wrap">
    <h2 class="knc-compare-title">NORIKS vs gli altri</h2>
    <div class="knc-table-scroll">
      <table class="knc-table">
        <thead>
          <tr>
            <th class="knc-feat"></th>
            <th class="knc-comp">Calze classiche<span>(Bauerfeind, medi…)</span></th>
            <th class="knc-comp">Calze da TV<span>(Zip Sox &amp; Co.)</span></th>
            <th class="knc-us">NORIKS<em class="knc-badge">N. 1</em></th>
          </tr>
        </thead>
        <tbody>
          <tr><td>Compressione medica</td><td class="ok">✓</td><td class="no">✕</td><td class="us ok">✓</td></tr>
          <tr><td>Cerniera per un'infilata facile</td><td class="no">✕</td><td class="ok">✓</td><td class="us ok">✓</td></tr>
          <tr><td>Infilata autonoma senza aiuto</td><td class="no">✕</td><td class="mid">~</td><td class="us ok">✓</td></tr>
  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <?php if ( $kn_img_1 ) : ?>
          <img loading="lazy" decoding="async" style="width:100%; aspect-ratio:1/1; object-fit:cover;" src="<?php echo esc_url( $kn_img_1 ); ?>" alt="Calze a compressione">
    ...
    <div class="why-col why-content">
      <h2 style="color: #222; text-align:left; margin-left: 20px; font-family: 'Barlow', sans-serif; color:#222223;">
        PERCHÉ LE CALZE A COMPRESSIONE?
      </h2>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Migliore circolazione, meno stanchezza</strong></p>
        <p class="description">La compressione graduale stimola delicatamente il flusso sanguigno verso il cuore, riduce la sensazione di pesantezza e stanchezza alle gambe e aiuta a mantenerle leggere anche durante la giornata più lunga.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Meno gonfiore</strong></p>
        <p class="description">Ideali per lunghi viaggi, per stare a lungo in piedi o seduti. La pressione uniforme riduce la ritenzione di liquidi e il gonfiore di caviglie e polpacci.</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>Un supporto che si sente</strong></p>
        <p class="description">Il taglio anatomico mantiene la calza al suo posto, senza stringere in alto. Una sensazione di supporto deciso ma confortevole per tutta la giornata.</p>
      </div>
    </div>
...
<section class="why-section knc-ugc">
  <div class="knc-ugc-wrap">
    <h2 class="knc-ugc-title">Cosa dicono i nostri clienti</h2>
