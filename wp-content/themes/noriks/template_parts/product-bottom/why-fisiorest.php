 ...
 *
 * SCAFFOLD — media nel tema: img/fisiorest*.
 */
if ( ! defined( 'ABSPATH' ) ) { exit; }

// 1) "Scientificamente supportato" — 4 schede.
$fis_science = array(
    array( 'title' => 'Gobba sul collo',        'text' => 'La trazione <strong>allevia la pressione e ripristina la postura corretta</strong>, riducendo la gobba causata dal collo tecnologico.' ),
    array( 'title' => 'Dolori al collo',        'text' => '<strong>Allevia i nodi muscolari e la rigidità</strong> e <strong>riallinea la curvatura del collo</strong> per un sollievo rapido dal dolore.' ),
    array( 'title' => 'Sonno di qualità',       'text' => 'La terapia rilassante <strong>distende collo e colonna vertebrale</strong> per un sonno profondo e rigenerante.' ),
    array( 'title' => 'Riduzione dello stress', 'text' => 'Il massaggio caldo e lo stretching <strong>sciolgono la tensione accumulata</strong> per un maggiore comfort.' ),
);
$fis_v = get_template_directory_uri() . '/img/fisiorest-videos/';
$fis_hero_video = $fis_v . 'hero.mp4';

// 3) Raccomandato dagli esperti
$fis_experts = array(
    array( 'vid' => $fis_v.'v01.mp4', 'name' => 'Marina Ferrari',   'role' => 'Massoterapista certificata',  'org' => '' ),
    array( 'vid' => $fis_v.'v08.mp4', 'name' => 'Dott.ssa Anna Ricci', 'role' => 'Dottoressa in fisioterapia', 'org' => '' ),
    array( 'vid' => $fis_v.'v03.mp4', 'name' => 'Dott. Ivan Conti',  'role' => 'Dottore in chiropratica',     'org' => '' ),
);
// 4) Esperienze degli utenti
$fis_ugc = array(
    array( 'vid' => $fis_v.'v09c.mp4', 'cap' => '„Per la prima volta dopo tanto tempo sono finalmente senza dolore…"' ),
    array( 'vid' => $fis_v.'v06.mp4', 'cap' => '„Il cuscino NORIKS è diventato un mio must quotidiano…"' ),
    array( 'vid' => $fis_v.'v11c.mp4', 'cap' => '„Mi aiuta tantissimo ad alleviare la tensione a collo e spalle."' ),
    array( 'vid' => $fis_v.'v02c.mp4', 'cap' => '„Se sei appena diventata mamma, potrebbe essere proprio ciò che ti serve…"' ),
);
// 5) ThermoTrac 3-in-1
$fis_thermo = array(
    array( 'vid' => $fis_v.'v10.mp4', 'title' => 'Terapia con trazione' ),
    array( 'vid' => $fis_v.'v07.mp4', 'title' => 'Terapia con vibrazione' ),
    array( 'vid' => $fis_v.'v05.mp4', 'title' => 'Terapia con calore' ),
);
// 6) Quattro miglioramenti
$fis_upgrades = array(
    array( 't' => 'Batteria ricaricabile',   'd' => 'Portalo ovunque — la batteria da 2500 mAh dura fino a 2 ore.' , 'ico' => 'battery-v2.png' ),
    array( 't' => 'Rivestimento in seta di gelso', 'd' => 'Avvolto in seta rinfrescante per una sensazione morbida e lussuosa.' , 'ico' => 'silk-v2.png' ),
    array( 't' => 'Spegnimento dopo 30 min', 'd' => 'Quattro sessioni da 30 minuti con una sola ricarica, senza pensieri.' , 'ico' => 'timer-v2.png' ),
    array( 't' => 'Calore regolato',         'd' => 'Riscaldamento a 50 °C con l\'avanzata tecnologia ThermoTrac.' , 'ico' => 'heat-v2.png' ),
);
?>

<!-- ============ 1) Scientificamente supportato ============ -->
<section class="fis-science">
  <div class="fis-wrap">
    <div class="fis-box">
      <h2 class="fis-title">Scientificamente supportato: sollievo comprovato per la cura del collo</h2>
      <div class="fis-grid">
...
<section class="fis-hero">
  ...
  <div class="fis-hero-inner">
    <h2 class="fis-hero-title">Sblocca un profondo reset con la forza combinata di allineamento e rilassamento</h2>
  </div>
</section>
...
<section class="fis-experts">
  <div class="fis-wrap fis-exp-grid">
    <div class="fis-exp-quote">
      <h2 class="fis-h2">Raccomandato dagli esperti</h2>
      <p>„NORIKS è uno dei migliori cuscini per il collo attualmente sul mercato. Faccio parte della comunità wellness da oltre 25 anni e ho provato diversi cuscini per il collo: ciò che distingue NORIKS è la funzione di trazione…</p>
      <p>Se hai la testa protesa in avanti o una 'postura curva', la trazione può aiutare a riallineare le vertebre e a sostenere completamente il corpo. Lo uso io stessa e lo consiglio ai miei clienti!"</p>
      <p class="fis-exp-author"><strong>Marina Ferrari</strong><br>Massoterapista certificata</p>
    </div>
...
<section class="fis-thermo">
  <div class="fis-wrap">
    <p class="fis-eyebrow"><strong>ThermoTrac™</strong> tecnologia</p>
    <h2 class="fis-h2 fis-center">Prova la terapia 3-in-1 per il collo</h2>
...
<section class="fis-upg">
  <div class="fis-wrap">
    <h2 class="fis-h2 fis-center">Quattro grandi miglioramenti</h2>
...
<!-- ============ 7) Progettato da ingegneri ============ -->
<section class="fis-eng">
  <div class="fis-wrap fis-row2">
    <div class="fis-row2-copy">
      <h2 class="fis-h2">Progettato da ingegneri. Realizzato secondo gli standard della fisioterapia</h2>
      <p>Abbiamo investito oltre 50.000 € e 2 anni di sviluppo affinché NORIKS non fosse solo un dispositivo di massaggio per il collo. È un dispositivo completo per la terapia del collo che cura davvero la causa. Ogni ordine passa attraverso un rigoroso controllo qualità per arrivare in condizioni perfette.</p>
    </div>
...
<section class="fis-cheaper">
  <div class="fis-wrap fis-row2">
    ...
    <div class="fis-row2-copy">
      <p class="fis-eyebrow">TERAPIA SICURA E RILASSANTE</p>
      <h2 class="fis-h2">14× più economico delle sedute settimanali</h2>
      <p>NORIKS si ripaga in giorni, non in mesi. Raccomandato dai terapisti, offre un sollievo delicato senza pressioni brusche o interventi rischiosi. Usalo ogni sera. Nessuna prenotazione. Nessuno spostamento. Nessun costo ricorrente — solo una cura del collo sicura e costante, ogni volta che ne hai bisogno.</p>
    </div>
  </div>
</section>
...
<style>
  ...
  /* 1) Scientificamente supportato — scheda grigia */
  ...
  /* Nessun link "Tabella delle taglie" su FisioRest (identico a bunion). */
  .noriks-global-sizechart, .gck-size-link, .gck-size-link-wrap,
  #open-size-chart, #open-size-chartCustom { display: none !important; }

  /* Descrizione breve: nascondi i punti standard (•), spaziature. */
...
<script>
/* Bundle-option attiva arancione tramite inline !important (sopravvive a LiteSpeed UCSS). */
(function(){
  function paintOrto(){
