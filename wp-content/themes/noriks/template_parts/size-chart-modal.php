...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog" aria-labelledby="custom-size-chart-title">
  <div class="size-chart-titlebar">
    <h2 id="custom-size-chart-title">Tabella taglie</h2>
  ...
  <div  style="<?php if ( has_term( array( 'orto-starter', 'orto-majica-bokserica' ), 'product_cat', get_the_ID() ) ): ?>  display: block; <?php endif; ?>"
      ...
      <div class="noriks-bx">
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Taglia</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Misure boxer: a, b, c, d" loading="lazy">
        <p class="noriks-bx-note"><strong>Scegli la stessa taglia che indossi di solito.</strong><br>Le misure sono in centimetri. Le taglie possono variare di &plusmn;1&ndash;2 cm. Se sei tra due taglie, scegli la più piccola &mdash; il tessuto è elastico.</p>
      </div>
    ...
    style="margin-top: 35px;margin-bottom: 0px;"
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">Come misurare i fianchi</p>
        <p style="margin:0 0 14px;line-height:1.6;font-size:14px;color:#333;">Avvolgi il metro intorno alla parte più larga dei fianchi (sopra i glutei), senza stringere, e annota la misura in centimetri.</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Taglia</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Fianchi (cm)</th>
          </tr></thead>
          <tbody>
          <?php foreach ( array(array('S','fino a 76 cm','fino a 30"'),array('M','77 – 85 cm','30 – 33"'),array('L','86 – 94 cm','34 – 37"'),array('XL','95 – 102 cm','37 – 40"'),array('2XL','103 – 114 cm','41 – 45"'),array('3XL','115 – 121 cm','45 – 48"'),array('4XL','122 – 129 cm','48 – 51"'),array('5XL','130 – 137 cm','51 – 54"'),array('6XL','138 – 145 cm','54 – 57"'),array('7XL','146 – 153 cm','57 – 60"'),array('8XL','154 cm e oltre','61" e oltre') ) as $i=>$r): ?>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Tra due taglie?</strong> Consigliamo la taglia più grande per un comfort ottimale e il massimo assorbimento.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <table style="width:100%;border-collapse:collapse;font-size:16px;">
          <thead><tr style="background:#111;color:#fff;">
            <th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Taglia</th><th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Peso corrispondente</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Scegli la taglia in base al tuo peso. Tra due taglie? Per una compressione più forte scegli la taglia più piccola.</p>
      </div>
      ...
      <div class="noriks-size-chart-wrap">
          ...
          <table class="noriks-sc">
            <thead>
              <tr>
                ...
                <th class="noriks-sc-empty" style="width:80px;">Taglia</th>
                <th>59-68 kg</th>
                <th>69-77 kg</th>
                <th>78-84 kg</th>
                <th>84-95 kg</th>
            ...
            <tbody>
              <tr>
                <th class="noriks-sc-vis-label" rowspan="11">Altezza (cm)</th>
                <th>168 cm</th>
        ...
        <div class="noriks-sc-steps">
          <h3>Come trovare la tua taglia</h3>
          <div class="noriks-sc-steps-grid">
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">1</span>
              <span>Trova la tua <strong>altezza</strong> nella colonna a sinistra.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">2</span>
              <span>Trova il tuo <strong>peso</strong> nella riga in alto.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">3</span>
              <span>Il campo dove si intersecano &mdash; questa è la tua taglia.</span>
            </div>
          </div>
        </div>
        ...
        <div class="noriks-sc-pro">
          ...
          <span>Se sei tra due taglie e vuoi una <strong>vestibilità più rilassata</strong>, prendi quella più grande. Per un <strong>look più aderente</strong> prendi quella più piccola.</span>
        </div>

        <div class="noriks-sc-guarantee">
          <span class="noriks-sc-check">&#10003;</span>
          <span>Non sei sicuro? Cambio taglia gratuito entro 90 giorni.</span>
        </div>
      </div>
