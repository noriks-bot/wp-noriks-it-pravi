<?php
/**
 * Template Name: Istruzioni per l'uso
 *
...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Scarica le istruzioni del tuo prodotto NORIKS in formato PDF.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Cerca per nome del prodotto…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                Scarica PDF <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Pagina del prodotto</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Nessuna istruzione per questo termine. Scrivici a <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Hai bisogno di aiuto con un prodotto? Scrivici a <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
