    ...
    <div class="footer-col">
      <div class="link-section">
        ...
        <span style="color: white; font-family: 'Roboto', sans-serif; font-size: 33px; font-weight: bold; letter-spacing: 1.75px;">NORIKS</span>
              ...
              <p class="footer-brand-dec" style="padding-right: 100px; font-size:12px;" >NORIKS è nato per risolvere un problema semplice ma spesso trascurato: gli uomini meritano vestiti che gli stiano davvero bene.
Nato dalla frustrazione per capi basici corti, stretti e mal tagliati, NORIKS disegna capi senza tempo per fisici più robusti — più lunghi, più comodi e realizzati con cura dove conta di più. 
</p>
      </div>
    </div>
