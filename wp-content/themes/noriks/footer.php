...
<<<<<<< HEAD
        <a style="margin-top:-10px;" href="https://noriks.com/it">
=======
...
=======
              <p class="footer-brand-dec" style="padding-right: 100px; font-size:12px;" >Η NORIKS δημιουργήθηκε για να λύσει ένα απλό, αλλά συχνά παραμελημένο πρόβλημα: οι άνδρες αξίζουν ρούχα που τους ταιριάζουν πραγματικά.
Ξεκινώντας από την απογοήτευση με κοντά, στενά και κακοραμμένα βασικά κομμάτια, η NORIKS σχεδιάζει διαχρονικά ρούχα για δυνατή σωματική διάπλαση — πιο μακριά, πιο άνετα και προσεκτικά κατασκευασμένα εκεί που μετράει περισσότερο. 
>>>>>>> 65cb868516d40f3fcbaffd3799194a6a5a8cbd7f
</p>
      </div>
    </div>
