...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      ...
      <span><a href="/it/shop">30 dana bez rizika – probaj bez brige</a></span>
      <!--<span><a href="/it/shop">Offerta invernale: fino al 70% di sconto!</a></span>-->
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/it/product-category/bokserice-sastavi-paket/">Crea il tuo pacchetto</a>
                        <a href="/it/product-category/bokserice/">Pacchetti pronti</a>
                    </div>
                    -->
                </div>
...
<a href="/hr" class="language-option">
    <img src="https://static.devit.software/countries/flags/rectangle/hr.svg"><span>Italia (IT)</span>
  </a>
