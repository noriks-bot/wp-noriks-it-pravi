...
const NORIKS_FLASH_CAT   = 'saldi-estivi';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Saldi estivi">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Sconto di stagione</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Saldi estivi</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Scontato fino a esaurimento scorte</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">L’offerta scade tra</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>giorni</em></span>
