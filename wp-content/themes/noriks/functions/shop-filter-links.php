...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			'piu-venduti' => 'Più venduti',
			'pacchetto-starter' => 'Pacchetto starter',
			'pacchi-grandi' => 'Pacchi grandi',
		),
		'boxer' => array(
			'1-pezzo-boxer' => '1 pezzo',
			'confezione-3-boxer' => 'Confezione 3',
			'confezione-5-boxer' => 'Confezione 5',
			'confezione-7-boxer' => 'Confezione 7',
			'confezione-10-boxer' => 'Confezione 10',
			'confezione-15-boxer' => 'Confezione 15',
			'neri' => 'Neri',
			'colori-boxer' => 'Colori',
		),
		'calzini' => array(
			'calzini-neri' => 'Neri',
			'calzini-bianchi' => 'Bianchi',
		),
		'magliette' => array(
			'1-pezzo-maglietta' => '1 pezzo',
			'confezione-3-magliette' => 'Confezione 3',
			'confezione-6-magliette' => 'Confezione 6',
			'confezione-9-magliette' => 'Confezione 9',
			'confezione-12-magliette' => 'Confezione 12',
			'confezione-15-magliette' => 'Confezione 15',
			'magliette-nere' => 'Neri',
			'colori-magliette' => 'Colori',
		),
		'set' => array(
			'set-2-magliette-5-boxer' => 'Set: 2+5',
			'set-4-magliette-10-boxer' => 'Set: 4+10',
			'set-5-magliette-5-boxer' => 'Set: 5+5',
		)
	) );
}
