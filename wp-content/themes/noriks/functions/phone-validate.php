 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+39...),
...
define( 'NORIKS_TEL_EXAMPLE', '3123456789' );

/** Sporocilo ob napacni stevilki — eno samo mesto za ves trg. */
function noriks_tel_message() {
    return 'Controlla il numero di telefono — sembra incompleto. es. ' . NORIKS_TEL_EXAMPLE;
}
