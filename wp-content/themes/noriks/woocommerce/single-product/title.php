...
<div class="rating">
    ...
    <div class="reviews">
      <a style="color:black;" href="#reviews-section">Eccellente 4.8 | <?php echo get_field('singlepp_reviews_text_1', 'option'); ?> <?php echo get_field('singlepp_reviews_text_2', 'option'); ?></a>
    </div>
  </div>
