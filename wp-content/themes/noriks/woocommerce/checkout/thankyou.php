...
$upsell_product_id = 2781; // Boxer Neri (primary offer)
$upsell_product    = wc_get_product( $upsell_product_id );
$upsell_name       = $upsell_product ? $upsell_product->get_name() : 'Boxer Neri';
        ...
        <div class="ty_upsell_one_wrapper show" id="ty-upsell"
            ...
            <div class="ty_upsell_one_wrapper__popup-content">
                ...
                <div class="tyuo_timer">
                    ...
                    <div class="title">Aggiungi un altro prodotto con il 50% di sconto extra</div>
                </div>
        ...
        <div class="ty-grid-section" id="ty-grid-section">
            <div class="ty-grid-popup">
                <div class="ty-grid-header" onclick="tyToggle(this)" style="cursor:pointer;">
                    <div>
                        <div style="margin:0;font-size:15px;font-weight:400;color:#fff;text-align:center;">Ancora più prodotti scontati</div>
                        <div style="font-size:20px;font-weight:700;color:#fff;line-height:1.3;text-align:center;">Aggiungi qualsiasi prodotto con il 50% di sconto</div>
                    </div>
